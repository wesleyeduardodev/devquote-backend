...
public final class DeliveryAdapter {
    ...
    public static DeliveryResponse toResponseDTO(Delivery entity) {
        ...
        return DeliveryResponse.builder()
                ...
                .taskLink(entity.getTask() != null ? entity.getTask().getLink() : null)
                .taskValue(entity.getTask() != null ? entity.getTask().getAmount() : null)
                .moduleId(entity.getTask() != null && entity.getTask().getModule() != null ? entity.getTask().getModule().getId() : null)
                .moduleName(entity.getTask() != null && entity.getTask().getModule() != null ? entity.getTask().getModule().getName() : null)
                .serverId(entity.getTask() != null && entity.getTask().getServer() != null ? entity.getTask().getServer().getId() : null)
                .serverName(entity.getTask() != null && entity.getTask().getServer() != null ? entity.getTask().getServer().getName() : null)
                .serverLink(entity.getTask() != null && entity.getTask().getServer() != null ? entity.getTask().getServer().getLink() : null)
